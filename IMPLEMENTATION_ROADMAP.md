...
### 완료된 작업
- ✅ **관전자 모드 GUI 버그 수정** (v2.1 준비 완료)

### 미완료 작업 요약

| 순위 | 항목 | 우선순위 | 작업 시간 | 의존성 |
|------|------|----------|-----------|--------|
| **1** | 실시간 인벤토리 동기화 | HIGH | 6시간 | 없음 |
| **2** | 경험치 백업 기능 | MEDIUM | 8시간 | 없음 |
| **3** | GUI 현지화 개선 | LOW | 2시간 | 없음 |
| **4** | SQL 마이그레이션 | MEDIUM | 5주 | 없음 (선택적) |
| **5** | 백업 압축 옵션 | LOW | 4시간 | 없음 |
